...
async function BuscarHoraNoHistorico() {
  try {
      ...
      try {
          ...
          const LinhasDesejadasHistorico = data.filter(linha => linha.Estacao === DadosEstacao || linha.Estacao === DadosEstacao+"\r");
          console.log(LinhasDesejadasHistorico)
          ...
          console.log(NumeroLinhasDesejadasHistorico)
...
// Inicia o codigo por completo do projeto (Dados do SQL + Simulação 3D)
async function CodigoGeral() {
  await DefinirDados();
